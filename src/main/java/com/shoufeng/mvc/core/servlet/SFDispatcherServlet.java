package com.shoufeng.mvc.core.servlet;


import com.shoufeng.mvc.core.annotation.*;
...
//    private Map<String,Method> handlerMapping = new HashMap<String,Method>();
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        System.out.println("SF Spring framework is init.");
...
//        if(!this.handlerMapping.containsKey(url)){
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            //保存写在类上面的@SFRequestMapping("/demo")
            String baseUrl = "";
    ...
    private void doAutowired() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            for (Field field : fields) {
                ...
                SFAutowired autowired = field.getAnnotation(SFAutowired.class);
        ...
        try {
            for (String className : classNames) {
                ...
                if (clazz.isAnnotationPresent(SFController.class)) {
                    ...
                    //1、自定义的beanName
                    SFService service = clazz.getAnnotation(SFService.class);
        ...
        private void putParamIndexMapping(Method method) {
            ...
            for (int i = 0; i < pa.length; i++) {
                for (Annotation a : pa[i]) {
                    if (a instanceof SFRequestParam) {
                        String paramName = ((SFRequestParam) a).value();
